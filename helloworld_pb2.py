...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x10helloworld.proto\x12\nhelloworld\"\x1c\n\x0cHelloRequest\x12\x0c\n\x04name\x18\x01 \x01(\t\"\x1d\n\nHelloReply\x12\x0f\n\x07message\x18\x01 \x01(\t\"\'\n\x11\x45xperimentDetails\x12\x12\n\nproject_id\x18\x01 \x01(\t\".\n\x04\x44\x61ta\x12\x0f\n\x07\x64\x61ta_id\x18\x01 \x01(\t\x12\x15\n\rdata_elements\x18\x02 \x03(\t2\x8e\x01\n\x07Greeter\x12>\n\x08SayHello\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply\"\x00\x12\x43\n\rSayHelloAgain\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply\"\x00\x32M\n\x0c\x64\x61taProvider\x12=\n\x08sendData\x12\x1d.helloworld.ExperimentDetails\x1a\x10.helloworld.Data\"\x00\x42\x36\n\x1bio.grpc.examples.helloworldB\x0fHelloWorldProtoP\x01\xa2\x02\x03HLWb\x06proto3')
...
Data = _reflection.GeneratedProtocolMessageType('Data', (_message.Message,), {
  'DESCRIPTOR' : _DATA,
  '__module__' : 'helloworld_pb2'
  # @@protoc_insertion_point(class_scope:helloworld.Data)
  })
_sym_db.RegisterMessage(Data)

_GREETER = DESCRIPTOR.services_by_name['Greeter']
_DATAPROVIDER = DESCRIPTOR.services_by_name['dataProvider']
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GREETER._serialized_end=325
  _DATAPROVIDER._serialized_start=327
  _DATAPROVIDER._serialized_end=404
